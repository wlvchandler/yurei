...
extern Options oni16_options;

void parseOptions(const std::vector<std::string>&);
...
class Assembler {
  ...
  private:
    const std::unordered_map<std::string, Mnemonic> opcodes = {
        ...
        { "MUL", Mnemonic::MUL },     { "SMUL", Mnemonic::SMUL },  { "DIV", Mnemonic::DIV },
        { "SDIV", Mnemonic::SDIV },   { "AND", Mnemonic::AND },    { "OR", Mnemonic::OR },
        { "XOR", Mnemonic::XOR },     { "NOT", Mnemonic::NOT },    { "SHR", Mnemonic::SHR },
        { "SHL", Mnemonic::SHL },     { "JUMP", Mnemonic::JUMP },  { "JZ", Mnemonic::JZ },
        { "JNZ", Mnemonic::JNZ },     { "JC", Mnemonic::JC },      { "JNC", Mnemonic::JNC },
        { "CALL", Mnemonic::CALL },   { "RET", Mnemonic::RET },    { "A", Mnemonic::A },
        { "B", Mnemonic::B },         { "C", Mnemonic::C },        { "D", Mnemonic::D },
        { "I", Mnemonic::I },         { "J", Mnemonic::J },        { "SP", Mnemonic::SP },
        { "PC", Mnemonic::PC },       { "FLAGS", Mnemonic::FLAGS }
    };
